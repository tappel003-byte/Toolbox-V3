  ...
  function renderPlanSetup(app, id) {
    ...
    function scheduleSave() {
      ...
      saveTimer = setTimeout(function () {
        flushSave().catch(function () {
          // flushSave keeps the record dirty and displays the retry state.
        });
      }, AUTOSAVE_DELAY_MS);
    }
    ...
    backBtn.addEventListener('click', function () {
      flushSave().then(function () {
        ...
        // flushSave already reports the failure. Stay on Plan Setup so the
        // investigator can retry without losing acknowledged work.
      });
    });
    ...
    continueBtn.addEventListener('click', function () {
      flushSave().then(function () {
        ...
        // Do not leave the source screen until its changes are durable.
      });
    });
